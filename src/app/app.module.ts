...
@NgModule({
  declarations: [
    AppComponent, MyComponent, ImageDisplay,ForEachComponent, IfExampleComponent, CustomDirective,  PipeExampleComponent, SortPipe, MyServiceComponent, EmplyeeDetailsComponent, PostExampleComponent, MyFormComponent,  MyReactiveComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
